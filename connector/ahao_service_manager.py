#!/usr/bin/env python3
"""
阿豪系统服务管理脚本 - 启动/停止所有核心服务

用法:
    python3 ~/.vectorbrain/connector/ahao_service_manager.py start    # 启动所有
    python3 ~/.vectorbrain/connector/ahao_service_manager.py stop     # 停止所有
    python3 ~/.vectorbrain/connector/ahao_service_manager.py restart  # 重启所有
    python3 ~/.vectorbrain/connector/ahao_service_manager.py status   # 查看状态
"""
...
"""
    ...
    "spiderman_monitor": {
        "script": "monitor_spiderman_group_v2.py",
        "log": "spiderman_monitor.log",
        "loop": True,
        "interval": 600,  # 10 分钟检查一次
        "code": """
import time
from monitor_spiderman_group_v2 import main
while True:
    try:
        main()
...
def cmd_status():
    """查看状态"""
    os.system(f"python3 {CONNECTOR_DIR}/ahao_health_check.py")
