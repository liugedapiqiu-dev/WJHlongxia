...
TASKS_CONFIG = [
    ...
    {
        "name": "spiderman_monitor",
        "display_name": "蜘蛛侠群监控",
        "log_path": "~/.vectorbrain/connector/monitor_spiderman_group_v2.log",
        "pattern": r"监控开始|获取到 \d+ 条新消息|飞书通知已发送",
        "success_pattern": r"✅ |已保存|汇报完成",
        "error_pattern": r"❌ |Error|Traceback|异常"
    },
    {
