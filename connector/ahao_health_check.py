#!/usr/bin/env python3
"""
阿豪系统健康监控脚本 - 一键查看所有核心脚本运行状态

用法:
    python3 ~/.vectorbrain/connector/ahao_health_check.py
    
或者添加到 alias:
    alias ahao-status='python3 ~/.vectorbrain/connector/ahao_health_check.py'
"""
...
MONITOR_SERVICES = [
    ...
    {"name": "Spiderman Monitor", "pattern": "spiderman", "critical": False},
...
def print_status():
    ...
    log_files = [
        ...
        ("Spiderman Monitor", "~/.vectorbrain/connector/spiderman_monitor.log"),
    ]
