...
# 方案 B: 从备份恢复
cp ~/Desktop/skill-WJH002/vectorbrain/memory/*.db ~/.vectorbrain/memory/
...
# 2. 从备份恢复
cp ~/Desktop/skill-WJH002/vectorbrain/memory/{database}.db ~/.vectorbrain/memory/
...
# 2. 从备份恢复
cp ~/Desktop/skill-WJH002/skills/{skill_name}/skill.json ./
...
# 3. 从备份恢复
unzip ~/Desktop/skill-WJH002_*.zip -d ~/Desktop/restore
cp -r ~/Desktop/restore/skill-WJH002/vectorbrain/* ~/.vectorbrain/
cp -r ~/Desktop/restore/skill-WJH002/workspace/* ~/.openclaw/workspace/
...
### 内部联系
- **管理员:** 王健豪 (Feishu)
- **Backup 位置:** `~/Desktop/skill-WJH002_YYYY-MM-DD.zip`
