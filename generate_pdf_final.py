...
# 文档路径
doc_path = '/Users/jo/.openclaw/workspace/南野科技项目月报_2026-03-最终版.pdf'
...
content.append(Paragraph("汇报对象：供应链主管 王健豪", normal_style))
...
action_data = [
    ['优先级', '行动项', '负责人', '截止日', '状态'],
    ['P0', 'Switch 透明款配色确认', '王健豪', '03-07', '⏸️ 待决策'],
...
content.append(Paragraph("报告生成：AI 助手 阿豪", footer_style))
content.append(Spacer(1, 0.2*cm))
